    ...
    public partial class criacaoDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoricoRecrusos", x => x.HistoricoRecursoId);
                    table.ForeignKey(
                        name: "FK_HistoricoRecrusos_Meses_MesId",
                        column: x => x.MesId,
                        principalTable: "Meses",
                        principalColumn: "MesId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ApatamentoId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Apartamentos", x => x.ApatamentoId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlugeulId = table.Column<int>(nullable: false),
                    AluguelId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ServicoPredioId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ServicoId = table.Column<int>(nullable: false),
                    DataExcucao = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "64806348-d613-4692-aec5-fcceae289754", "445f587a-d6f1-4a2a-88e7-4a5f9a006c6d", "Morador do Prédio", "Morador", "MORADOR" },
                    { "647440f7-5dae-4d92-9726-36690435eebd", "ad423527-ae06-473f-a64f-60a1f9cb6a73", "Síndico do Prédio", "Sindico", "SINDICO" },
                    { "5aa15823-82cb-4a9e-846c-a0952723e33d", "0b8919a0-392f-4fb5-8b0c-bd17fac22d17", "Administrador do Prédio", "Administrador", "ADMINISTRADOR" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoricoRecrusos_MesId",
                table: "HistoricoRecrusos",
                column: "MesId");
